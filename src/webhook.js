...
class PARADISEWebhook extends EventEmitter {
  /**
   * Creates a new PARADISEWebhook Instance.
  ...
  constructor(port, path, auth, server) {
    ...
    super();
    this.port = port || 0;
    this.path = path || '/paradisewebhook';
    this.auth = auth;
...
module.exports = PARADISEWebhook;